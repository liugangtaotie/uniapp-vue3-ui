...
(t = this),
  (e = function() {
    ...
    function c() {
      ...
      return (
        1 === t.length
          ? r(t[0]) || Array.isArray(t[0])
            ? (a = t[0])
            : "string" == typeof t[0] && (n = t[0])
          : 2 === t.length &&
            ("string" == typeof t[0] && (n = t[0]), (r(t[1]) || Array.isArray(t[1])) && (a = t[1])),
        { locale: n, params: a }
      );
    }
    function u(t) {
        ...
        beforeCreate: function() {
          ...
          if (((t.i18n = t.i18n || (t.__i18n ? {} : null)), t.i18n)) {
            if (t.i18n instanceof et) {
              ...
              var n =
                this.$root && this.$root.$i18n && this.$root.$i18n instanceof et
                  ? this.$root.$i18n
                  : null;
              if (
                (n &&
              ...
              a && s(a) && (t.i18n.messages = m(t.i18n.messages, a)),
    ...
    function T(t, n, r) {
      ...
      if (c || u || h)
        if (c) {
          ...
          (t._vt = t.textContent =
            null != f
              ? (i = p.$i18n).tc.apply(i, [c, f].concat(L(u, h)))
              : (o = p.$i18n).t.apply(o, [c].concat(L(u, h)))),
    ...
    function I(t) {
      ...
      !(function(t) {
        ...
        F.mixin(g),
        F.directive("t", { bind: w, update: $, unbind: M }),
        F.component(v.name, v),
        F.component(k.name, k),
        (F.config.optionMergeStrategies.i18n = function(t, e) {
          return void 0 === e ? t : e;
        });
    }
    var D = function() {
    ...
    var O = /^(?:\d)+/,
      ...
      E = 8,
      z = [];
    (z[S] = { ws: [S], ident: [3, W], "[": [R], eof: [V] }),
      (z[1] = { ws: [1], ".": [2], "[": [R], eof: [V] }),
      (z[2] = { ws: [2], ident: [3, W], 0: [3, W], number: [3, W] }),
      (z[3] = {
        ident: [3, W],
        0: [3, W],
        number: [3, W],
      ...
      (z[R] = { "'": [H, W], '"': [P, W], "[": [R, N], "]": [1, A], eof: E, else: [R, W] }),
      (z[H] = { "'": [R, W], eof: E, else: [H, W] }),
      (z[P] = { '"': [R, W], eof: E, else: [P, W] });
          ...
          ((e = (function(t) {
            ...
            for (
              ...
              if ("\\" !== (e = t[++c]) || !p()) {
                ...
                if (
                  ((u = i[0]), (o = f[i[1]]) && ((r = void 0 === (r = i[2]) ? e : r), !1 === o()))
                )
                  return;
                if (u === V) return l;
              }
    ...
    return (
      (et.prototype._checkLocaleMessage = function(t, n, r) {
        var i = function(t, n, r, o) {
          if (s(r))
            Object.keys(r).forEach(function(e) {
              var a = r[e];
              s(a)
                ? (o.push(e), o.push("."), i(t, n, a, o), o.pop(), o.pop())
                : (o.push(e), i(t, n, a, o), o.pop());
            });
          else if (Array.isArray(r))
            r.forEach(function(e, r) {
              s(e)
                ? (o.push("[" + r + "]"), o.push("."), i(t, n, e, o), o.pop(), o.pop())
                : (o.push("[" + r + "]"), i(t, n, e, o), o.pop());
            });
          else if (a(r)) {
            if (X.test(r)) {
              var l =
      ...
      (et.prototype._initVM = function(t) {
        ...
        (F.config.silent = !0), (this._vm = new F({ data: t })), (F.config.silent = e);
      }),
      ...
      (et.prototype._link = function(t, e, n, r, a, i, o) {
        ...
        for (var c in l)
          if (l.hasOwnProperty(c)) {
            ...
            (g = this._warnDefault(t, _, g, r, Array.isArray(i) ? i : [i], a)),
              this._modifiers.hasOwnProperty(m)
                ? (g = this._modifiers[m](g))
                : Y.hasOwnProperty(m) && (g = Y[m](g)),
              o.pop(),
              (s = g ? s.replace(u, g) : s);
          }
        return s;
      ...
      (et.prototype._t = function(t, e, n, r) {
        ...
        return (
          (u = this._warnDefault(l, t, u, r, i, "string")),
      ...
      (et.prototype._getNumberFormatter = function(t, e, n, r, a, i) {
        ...
        if (i) f = new Intl.NumberFormat(o, Object.assign({}, p, i));
          ...
          var m = o + "__" + a;
          (f = this._numberFormatters[m]) ||
            (f = this._numberFormatters[m] = new Intl.NumberFormat(o, p));
        }
        return f;
      }),
