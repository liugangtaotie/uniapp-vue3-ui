  ...
  <view class="u-demo">
    <view class="u-demo-wrap">
      ...
      <view class="u-demo-area">
        <u-empty :mode="mode">
          <u-button v-if="slot" slot="bottom" size="medium"> slot按钮 </u-button>
        </u-empty>
      </view>
    </view>
...
export default defineComponent({
  ...
  setup() {
    let state = reactive({ mode: "data", slot: false });

    function modeChange(mode = "data") {
      state.mode = mode;
    }
