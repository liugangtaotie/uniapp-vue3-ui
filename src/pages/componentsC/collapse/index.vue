...
export default defineComponent({
  ...
  setup(props: any) {
      ...
      itemList: [
        {
          head: "赏识在于角度的转换",
          body:
            "只要我们正确择取一个合适的参照物乃至稍降一格去看待他人，值得赏识的东西便会扑面而来：闪光的道德、妙异的智慧、优美的人情…… 赏识不是单向的施舍，是智慧与智慧的主动碰撞",
          show: false,
        },
        {
        ...
        },
        {
          ...
          body:
            "这个材料反应的就是赏识的问题，赏识是一种理解和信任，包含了肯定与欣赏，也是一种激励和引导，可以使人悔过自新，扬长避短，更健康地成长和进步",
          show: false,
        },
      ],
      accordion: true,
    ...
    function accordionChange(index) {
      state.accordion = index == 0 ? true : false;
    }
