...
export default defineComponent({
  ...
  setup() {
    ...
    function thumbChange(index) {
      state.thumb =
        index == 0 ? "http://pic2.sc.chinaz.com/Files/pic/pic9/202002/hpic2119_s.jpg" : "";
    }

    function paddingChange(index) {
      state.padding = [20, 30, 40][index];
    }

    function bottomChange(index) {
      state.bottomSlot = !index;
    }
