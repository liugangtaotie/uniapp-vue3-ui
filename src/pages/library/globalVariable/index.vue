  ...
  <view class="u-demo">
    <view class="u-demo-wrap">
      ...
      <view class="u-demo-area">
        <view class="u-no-demo-here"> globalData方案的值为(曲折实现，全局动态响应) </view>
        <view class="u-demo-result-line">
          {{ globalData }}
        </view>
      </view>
      <view class="u-demo-area">
        <view class="u-no-demo-here"> Vue.prototype方案的值为(非动态响应，微信小程序无效) </view>
        <view class="u-demo-result-line">
          {{ vuePrototype }}
        </view>
      </view>
      <view class="u-demo-area">
        <view class="u-no-demo-here"> vuex方案的值为(全局动态响应，推荐) </view>
        <view class="u-demo-result-line">
          {{ vuex_demo }}
        </view>
      </view>
