...
// style 对象转字符串
import { styleObjToString } from "./libs/function/styleObjToString.js";
...
const install = (app) => {
  ...
  // app.filter("timeFormat", (timestamp, format) => {
  //   return timeFormat(timestamp, format);
  // });
  // app.filter("date", (timestamp, format) => {
  //   return timeFormat(timestamp, format);
  // });
  // // 将多久以前的方法，注入到全局过滤器
  // app.filter("timeFrom", (timestamp, format) => {
