...
export default defineComponent({
  ...
  setup(props: any, { emit }) {
    let state = reactive({
      ...
      avatar: props.src ? props.src : base64Avatar,
    });
    ...
    const wrapStyle = computed(() => {
      ...
      style["border-radius"] = props.mode == "circle" ? "500px" : "5px";
    ...
    const uSexStyle = computed(() => {
      let style: any = {};
      if (props.sexBgColor) style["background-color"] = props.sexBgColor;
      return styleObjToString(style);
    });
    ...
    const uLevelStyle = computed(() => {
      let style: any = {};
      if (props.levelBgColor) style["background-color"] = props.levelBgColor;
      return styleObjToString(style);
    });
