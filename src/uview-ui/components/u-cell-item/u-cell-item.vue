<template>
  ...
  >
    ...
    <view class="u-cell_title" :style="titleStyleStr">
      <block v-if="title !== ''">{{ title }}</block>
      <slot name="title" v-else></slot>

      <view class="u-cell__label" v-if="label || $slots.label" :style="labelStyleStr">
...
export default defineComponent({
  ...
  setup(props: any, { emit }) {
    ...
    const labelStyleStr = computed(() => {
      return styleObjToString(props.labelStyle);
    });

    const valueStyleStr = computed(() => {
      return styleObjToString(props.valueStyle);
    });
